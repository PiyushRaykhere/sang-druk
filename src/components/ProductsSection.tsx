...
const ProductsSection = () => {
  return (
    <section id="products" className="relative py-20 lg:py-28 bg-gradient-section overflow-hidden">
      <div className="absolute -top-40 right-1/4 w-[500px] h-[500px] rounded-full bg-gradient-gold-soft blur-3xl opacity-50 pointer-events-none" />
            ...
            <Reveal key={i} delay={i * 90}>
              ...
              >
                <div className="relative overflow-hidden">
                  <img src={p.img} alt={p.title} className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-700" loading="lazy" width={400} height={300} />
